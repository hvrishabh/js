...
///////////////////////////////
////////////// .......l161 some and every method.........

console.log(movements);
// includes is used to test if an array includes a certain value or not.
// includes test for the equality (value must be there , for includes to be true  )
console.log(movements.includes(-130));
console.log(movements.some(mov => mov === -130));
// we prefer includes() method for the simple comparision of equality

// but if we want to test for an condition instead, then we use some() method.

// if there is any deposit in this account above 1500, the result will be true or false.
...
// EVERY () if every element pass the condition then only it will result true in the callback
